...
class MLPWrapper():
    def __init__(self, 
        ...
        n_units = n_units if n_units is not None else trial.suggest_int("n_units", 1, 1000)
        n_layers = n_layers if n_layers is not None else trial.suggest_int("n_layers", 1, 1000)
