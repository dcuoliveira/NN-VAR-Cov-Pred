...
def train_and_evaluate(param, data, target_name, model, epochs, criterion):
...
def objective(trial, data, target_name, epochs, criterion):
     ...
     params = {
              ...
              'input_size': data.drop([target_name], axis=1).shape[1],
              }
    
     model = build_model(params)
     loss_values, preds = train_and_evaluate(params, data, target_name, model, epochs, criterion)
...
if __name__ == "__main__":
    ...
    study.optimize(lambda trial: objective(trial, data, target_name, epochs, criterion), n_trials=100)